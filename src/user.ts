...
export function registerAnonymousAccount(
  params: RegisterAnonymousAccountParams
): Promise<any> {
  return tuya.registerAnonymousAccount(params);
}
...
export type RegisterAnonymousAccountParams = {
  countryCode: string;
  nickName: string;
}
